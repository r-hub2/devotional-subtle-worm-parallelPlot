(() => {
  ...
  var ParallelPlot = class _ParallelPlot {
    ...
    generate(config) {
      ...
      this.axeHeight = this.height - _ParallelPlot.margin.top - _ParallelPlot.margin.bottom;
      ...
      select_default2(this.bindto).append("div").attr("class", "ppDiv").classed("withWidgets", controlWidgets).classed("withoutWidgets", !controlWidgets);
    ...
    appendPlotSvg() {
      const ppDiv = select_default2(this.bindto + " .ppDiv");
      const svg = ppDiv.append("svg").attr("width", this.width).attr("height", this.height);
      this.addGlow();
    ...
    getPlotConfig() {
      const allDimensions = Object.keys(this.sampleData[0]);
      const controlWidgets = select_default2(this.bindto + " .ppDiv").classed("withWidgets");
